...
![image-20240610221948244](C:\Users\JIA\AppData\Roaming\Typora\typora-user-images\image-20240610221948244.png)
...
1. 会造成ABA问题，即T1读取内存变量为A,T2修改内存变量为B,T2修改内存变量为A,这时T1再CAS操作A时是可行的。但实际上在T1第二次操作A时，已经被其他线程修改过了
